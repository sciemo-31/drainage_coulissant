...
def calculer_coulissant_2r3vd_d(choix, L):
    """
    Version optimisée du drainage pour un coulissant 2 rails 3 vantaux dépendants.
    Vantail extérieur à droite (Choix 4). Appelé directement par main.py.
    """
    ...
    if L < 3000:
        ...
        axe_1a = ((L / 3) - 6 - 80 - 160)
        axe_2a_1 = ((L / 3) + 47.5 - 160 - 80) / 2
        axe_2a_2 = ((L / 3) - 41.5 - 80 - 80) / 2
        ...
        axe_2a_1 = ((L / 3) + 47.5 - 160 - 80) / 4
        axe_2a_2 = ((L / 3) - 41.5 - 80 - 80) / 4
        ...
        axe_2a_1 = ((L / 3) + 47.5 - 160 - 80) / 5
        axe_2a_2 = ((L / 3) - 41.5 - 80 - 80) / 5
    ...
    # Boucle 1 : Calcul des premiers 2a
    nbr2a = 1
    while p_2a_1 <= (L / 3) + 47.5 and nbr2a <= nbr_2a_1:
    ...
    nbr2a = 1
    while p_2a_2 < L - (L / 3) - 6 and nbr2a <= nbr_2a_2:
        print(f"Drainage n° {nbrdrainage} => 2a : {round(p_2a_2)}")
        p_2a_2 += axe_2a_2
        nbr2a += 1
        nbrdrainage += 1

    # Boucle 3 : Calcul pour les 1a
    nbr1a = 1
    ...
    afficher_cotation(round(axe_2a_1, 2), round(axe_2a_2, 2), round(axe_1a, 2))


# Bloc de test autonome
if __name__ == "__main__":
    print("--- MODE TEST SOLO (Choix 4 Optimisé) ---")
    test_L = int(input("Entrez une longueur de traverse (mm) pour le test : "))
    calculer_coulissant_2r3vd_d(choix=4, L=test_L)

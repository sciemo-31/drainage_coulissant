...
def cotation_c1():
    ...
    b = round(axe_1a_c1, 2)  # entre-axe 1a partie droite
    c = round(axe_2a_c1, 2)  # entre axe 2a partie centrale
    d = round(axe_3a_c1, 2)   # entre axe 3a partie gauche
    print("=>D1: ", a, "\nD1->D2:", d, "\nD2->D3:", d, "\nD3->D4:", d,
          "\nD4->D5:", a, "\nD5->D6:", c, "\nD6->D7:", c, "\nD7->D8:", c, "\nD4->D5:", a, "\nD5->D6:", b, "\nD6->D7:", b)
...
def cotation_c2():
    a = 160  # départ entre secteur
    b = round(axe_1a_c2, 2)  # entre-axe 1a partie droite
    c = round(axe_2a_c2, 2)  # entre axe 2a partie centrale
    d = round(axe_3a_c2, 2)   # entre axe 3a partie gauche
    print("=>D1: ", a, "\nD1->D2:", d, "\nD2->D3:", d, "\nD3->D4:", d,
          "\nD4->D5:", d, "\nD5->D6:", a, "\nD6->D7:", c, "\nD7->D8:", c, "\nD8->D9:", c,
          "\nD9->D10:", c, "\nD10->D11:", a, "\nD11->D12:", b, "\nD12->D13:", b, "\nD13->D14:", b)
...
def cotation_c3():
    a = 160  # départ entre secteur
    b = round(axe_1a_c3, 2)  # entre-axe 1a partie droite
    c = round(axe_2a_c3, 2)  # entre axe 2a partie centrale
    d = round(axe_3a_c3, 2)   # entre axe 3a partie gauche
    print("=>D1: ", a, "\nD1->D2:", d, "\nD2->D3:", d, "\nD3->D4:", d,
          "\nD4->D5:", d, "\nD5->D6:", d, "\nD6->D7:", a, "\nD7->D8:", c, "\nD8->D9:", c,
          "\nD9->D10:", c, "\nD10->D11:", c, "\nD11->D12:", c, "\nD12->D13:", a, "\nD13->D14:", b, "\nD14->D15:", b,"\nD15>D16:", b, "\nD16->D17:", b)


if choix == 7 and L < 4000:
    print("--------------------------------")
    ...
    nbrdrainage = 1
    nbr1a = 1
    while p_1a <= (L/3)+29.5 and nbr1a <= nbr_1a_c1:
    ...
    while p_2a < (L/3)+29.5 + (L/3)-59 and nbr2a <= nbr_2a_c1:
        ...
        nbr2a += 1
        nbrdrainage += 1
    # calcul pour la partie droite de la traverse = 3a
    nbr3a = 1
    while p_3a < L - 158 and nbr3a <= nbr_3a_c1:
...
# calcul pour la partie gauche de la traverse = 1a
    nbrdrainage = 1
    nbr1a = 1
    while p_1a <= (L/3)+29.5 and nbr1a <= nbr_1a_c2:
        print("Drainage n°", nbrdrainage, "=> 1a :", round(p_1a))
        p_1a = p_1a + axe_1a_c2
        nbr1a += 1
        nbrdrainage += 1
...
# calcul pour la partie droite de la traverse = 3a
    nbr3a = 1
    while p_3a < L-158 and nbr3a <= nbr_3a_c2:
        print("Drainage n°", nbrdrainage, "=> 3a :", round(p_3a))
        p_3a = p_3a + axe_3a_c2
        nbr3a += 1
        nbrdrainage += 1
...
# calcul pour la partie gauche de la traverse = 1a
    nbrdrainage = 1
    nbr1a = 1
    while p_1a <= (L/3)+29.5 and nbr1a <= nbr_1a_c3:
        print("Drainage n°", nbrdrainage, "=> 1a :", round(p_1a))
        p_1a = p_1a + axe_1a_c3
        nbr1a += 1
        nbrdrainage += 1
...
# calcul pour la partie droite de la traverse = 3a
    nbr3a = 1
    while p_3a < L-158 and nbr3a <= nbr_3a_c3:
        print("Drainage n°", nbrdrainage, "=> 3a :", round(p_3a))
        p_3a = p_3a + axe_3a_c3
        nbr3a += 1
        nbrdrainage += 1
